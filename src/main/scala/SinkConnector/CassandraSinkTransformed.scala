...
class CassandraSinkTransformed extends ForeachWriter[TransactionTransformed]{
  ...
  override def process(t: TransactionTransformed): Unit = {
    val cols = "DeviceOS, Browser, DeviceType, ScreenResolution , DeviceInfo , uid , TransactionAmt , ProductCD , isFraud , card1 , card2 , card3 , card4 , card5 , card6 , region , country , R_emaildomain , P_emaildomain , TransactionDT , TransactionID ,D1, N_Trans_Last_month_TransactionAmt_less_35 int, N_Trans_Last_month_35_less_TransactionAmt_greater_80 int, N_Trans_Last_month_TransactionAmt_greater_80 int, N_Trans_Last_month int, IS_TransactionAmt_over_than_perc_of_the_mean_wrt_lastmonth text, N_Trans_Last_week_TransactionAmt_less int, N_Trans_Last_week_35_less_TransactionAmt_greater_80 int, N_Trans_Last_week_TransactionAmt_greater_80 int, N_Trans_Last_week int, IS_TransactionAmt_over_than_perc_of_the_mean_wrt_lastweek text, IS_DeviceOS_habitual text, IS_Browser_habitual text, IS_DeviceType_habitual text, IS_ScreenResolution_habitual text, IS_DeviceInfo_habitual text, IS_country_habitual text, IS_R_emaildomain_habitual text, IS_P_emaildomain_habitual text, IS_card4_habitual text, IS_card6_habitual text, "
