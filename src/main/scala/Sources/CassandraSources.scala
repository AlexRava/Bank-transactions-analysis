...
object CassandraSources {
  ...
  object DbHistoricalData extends BankCassandraSource{
    override def table: String = "transactions2"

    override def col: String = "DeviceOS, Browser, DeviceType, ScreenResolution , DeviceInfo , uid , TransactionAmt ,  isFraud ,  card2 , card3 , card4 , card5 , card6 ,  country , R_emaildomain , P_emaildomain , TransactionDT , TransactionID"
